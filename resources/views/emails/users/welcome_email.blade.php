...
<table border="0" cellspacing="0" cellpadding="0" class="table_width_100" width="100%" style="max-width: 680px; min-width: 300px;">
	...
	<tr><td align="center" bgcolor="#fbfcfd">
		...
		<table width="90%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td>
				Admin panel : 	<a href="{{$adminlink}}">{{$adminlink}}</a>
				</td>
			</tr>
			<tr>	
				<td>Your Website :	<a href="{{$websitelink}}">{{$websitelink}}</a></td>
			</tr>	
			<tr>
				<td>
				<span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #96a5b5;">Incase of any queries please check</span><span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #96a5b5;"><a href="#"> - Documentation</a></br></br></span>
				</td>
			</tr>
			<tr><td>
