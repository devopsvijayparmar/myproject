					...
					<table width="90%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td>
								...
								Thanks for getting started with {{config('enum.site_title')}}!<br/><br/>
								We just need to verify your email address before you can access {{config('enum.site_title')}}.<br/><br/>
								This link will verify your email address, and then you’ll officially be a part of the {{config('enum.site_title')}} community.<br/><br/>
								See you there!<br/><br/>
							</td>
						</tr>
						<tr>
