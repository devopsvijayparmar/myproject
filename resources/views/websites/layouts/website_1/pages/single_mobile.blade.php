        ...
        <div class="full">
          <div class="title-holder">
            <div class="title-holder-cell text-left">
              <h1 class="page-title">Mobile Detail</h1>
              <ol class="breadcrumb">
                <li><a href="{{url('/')}}">Home</a></li>
                <li class="active">Mobile Detail</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-xl-6 col-lg-12 col-md-12">
            <div class="product_detail_feature_img hizoom hi2">
              <div class='hizoom hi2'> <img src="{{$mobile->image_url_1}}" class="img-thumbnail" alt="#" /> </div>
            </div>
			<ul class="preview-thumbnail nav nav-tabs">
				@if($mobile->image_2)
			   <li> <a class="preview" href="{{$mobile->image_url_2}}" rel="prettyPhoto"><img class="img-thumbnail" src="{{$mobile->image_url_2}}" /></a></li>
				@endif
			   @if($mobile->image_3)
			   <li> <a class="preview" href="{{$mobile->image_url_3}}" rel="prettyPhoto"><img class="img-thumbnail" src="{{$mobile->image_url_3}}" /></a></li>
				@endif
			</ul>
          </div>
            ...
            <div class="product_list">
              ...
              <div class="product_detail_btm">
				...
				<div class="product_price">
				 <p><span class="">{{$productdata->brand->name}}</span></p>
				@php
				$currency_symbol = "";
				@endphp
				@if(isset($site_setting->currency->symbol)) @php $currency_symbol = $site_setting->currency->symbol @endphp @endif
