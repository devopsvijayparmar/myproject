@include('websites.saloon.include.header')
<section>
...
<section id="blog" style="padding-bottom:80px!important">
		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-6">
				<div class="product-grid" style="padding:0!important">
					...
					<div class="p-2">
						<div class="font-clr">{{ mb_strimwidth($productdata->name, 0, 40, "...")}}</div>
						@php
						$currency_symbol = "";
						@endphp
						@if(isset($site_setting->currency_symbol)) @php $currency_symbol = $site_setting->currency_symbol @endphp @endif
						@if($productdata->price)
						 <div class="font-clr"><div class="">{{$currency_symbol.$productdata->price}}</div></div>
						@endif
					</div>
				</div>
			</div>
	...
	<div class="text_align_center" style="margin-top: 10px;">
		<a class="btn btn-primary" href="{{$product[0]->getProjectCategoryLink($title)}}">See More...</a>
	</div>
	@endif
</section>
...
<section id="portfolio" >
	...
	@if(count($ourteam) > 0)
	<div class="text_align_center" style="margin-top: 10px;">
		<a class="btn btn-primary" href="{{$ourteam[0]->getOurTeamPageLink($title)}}">See More...</a>
	</div>
	@endif
</section><!--/#portfolio-->
