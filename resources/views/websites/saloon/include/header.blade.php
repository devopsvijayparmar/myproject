...
<head>
	...
	<!-- core CSS -->
    <link href="{{ asset('/websites/saloon/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/saloon/css/font-awesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/saloon/css/animate.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('/websites/saloon/css/prettyPhoto.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/saloon/css/main.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/saloon/css/responsive.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/saloon/css/custom.css') }}" rel="stylesheet">
