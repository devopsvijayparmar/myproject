<footer id="footer">
    ...
    <script src="{{ asset('/websites/saloon/js/jquery.js') }}"></script>
    <script src="{{ asset('/websites/saloon/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('/owl/owl.carousel-2.3.4.min.js') }}"></script>
    <script src="{{ asset('/websites/saloon/js/mousescroll.js') }}"></script>
    <script src="{{ asset('/websites/saloon/js/smoothscroll.js') }}"></script>
    <script src="{{ asset('/websites/saloon/js/jquery.prettyPhoto.js') }}"></script>
    <script src="{{ asset('/websites/saloon/js/jquery.isotope.min.js') }}"></script>
    <script src="{{ asset('/websites/saloon/js/jquery.inview.min.js') }}"></script>
    <script src="{{ asset('/websites/saloon/js/wow.min.js') }}"></script>
    <script src="{{ asset('/websites/saloon/js/main.js') }}"></script>
