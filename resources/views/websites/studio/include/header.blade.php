...
<head>
	...
	<!-- core CSS -->
    <link href="{{ asset('/websites/studio/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/studio/css/font-awesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/studio/css/animate.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('/websites/studio/css/main.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/studio/css/responsive.css') }}" rel="stylesheet">
