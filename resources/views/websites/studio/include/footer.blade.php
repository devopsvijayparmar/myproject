<footer id="footer">
    ...
    <script src="{{ asset('/websites/studio/js/jquery.js') }}"></script>
    <script src="{{ asset('/websites/studio/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('/owl/owl.carousel-2.3.4.min.js') }}"></script>
    <script src="{{ asset('/websites/studio/js/mousescroll.js') }}"></script>
    <script src="{{ asset('/websites/studio/js/smoothscroll.js') }}"></script>
    <script src="{{ asset('/websites/studio/js/jquery.prettyPhoto.js') }}"></script>
    <script src="{{ asset('/websites/studio/js/jquery.isotope.min.js') }}"></script>
    <script src="{{ asset('/websites/studio/js/jquery.inview.min.js') }}"></script>
    <script src="{{ asset('/websites/studio/js/wow.min.js') }}"></script>
