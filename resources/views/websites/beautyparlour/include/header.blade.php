...
<head>
	...
	?>
	<!-- core CSS -->
    <link href="{{ asset('/websites/beautyparlour/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/beautyparlour/css/font-awesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/beautyparlour/css/animate.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('/websites/beautyparlour/css/prettyPhoto.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/beautyparlour/css/main.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/beautyparlour/css/responsive.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/beautyparlour/css/custom.css') }}" rel="stylesheet">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
						...
						<li id="philosophy_tab" class="scroll"><a href="{{url('/')}}/{{$title}}/philosophy">Philosophy</a></li>
						 <li id="products" class="scroll"><a href="{{url('/')}}/{{$title}}/products/category">Products</a></li>
