<footer id="footer">
    ...
    <script src="{{ asset('/websites/beautyparlour/js/jquery.js') }}"></script>
    <script src="{{ asset('/websites/beautyparlour/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('/owl/owl.carousel-2.3.4.min.js') }}"></script>
    <script src="{{ asset('/websites/beautyparlour/js/mousescroll.js') }}"></script>
    <script src="{{ asset('/websites/beautyparlour/js/smoothscroll.js') }}"></script>
    <script src="{{ asset('/websites/beautyparlour/js/jquery.prettyPhoto.js') }}"></script>
    <script src="{{ asset('/websites/beautyparlour/js/jquery.isotope.min.js') }}"></script>
    <script src="{{ asset('/websites/beautyparlour/js/jquery.inview.min.js') }}"></script>
    <script src="{{ asset('/websites/beautyparlour/js/wow.min.js') }}"></script>
    <script src="{{ asset('/websites/beautyparlour/js/main.js') }}"></script>
