 ...
 <link href="{{ asset('/websites/mobile/css/single_product.css') }}" rel="stylesheet">
 <link rel='stylesheet' href="{{ asset('/websites/mobile/css/hizoom.css') }}">
...
@include('websites.mobile.include.footer')
 <script src="{{ asset('/websites/mobile/js/hizoom.js') }}"></script>
<script>
