...
<!-- bootstrap css -->
<link rel="stylesheet" href="{{ url('/websites/mobile/css/bootstrap.min.css') }}" />
<!-- Site css -->
<link rel="stylesheet" href="{{ url('/websites/mobile/css/style.css') }}" />
<!-- responsive css -->
<link rel="stylesheet" href="{{ url('/websites/mobile/css/responsive.css') }}" />
<!-- colors css -->
<link rel="stylesheet" href="{{ url('/websites/mobile/css/colors1.css') }}" />
<!-- custom css -->
<link rel="stylesheet" href="{{ url('/websites/mobile/css/custom.css') }}" />
<!-- wow Animation css -->
<link rel="stylesheet" href="{{ url('/websites/mobile/css/animate.css') }}" />
<!-- revolution slider css -->
<link rel="stylesheet" type="text/css" href="{{ url('/websites/mobile/revolution/css/settings.css') }}" />
<link rel="stylesheet" type="text/css" href="{{ url('/websites/mobile/revolution/css/layers.css') }}" />
<link rel="stylesheet" type="text/css" href="{{ url('/websites/mobile/revolution/css/navigation.css') }}" />
        ...
        <div class="col-md-4 right_section_header_top">
          <div class="float-left">
            <div class="social_icon">
              <ul class="list-inline">
                <?php if(isset($contact_us->facebook)) { ?><li><a class="fa fa-facebook clrblck" href="{{$contact_us->facebook}}" title="Facebook" target="_blank"></a></li><?php } ?>
                <?php if(isset($contact_us->twitter)) { ?><li><a class="fa fa-twitter clrblck" href="{{$contact_us->twitter}}" title="Twitter" target="_blank"></a></li><?php } ?>
                <?php if(isset($contact_us->instagram)) { ?><li><a class="fa fa-linkedin clrblck" href="{{$contact_us->instagram}}" title="LinkedIn" target="_blank"></a></li><?php } ?>
                <?php if(isset($contact_us->linkedin)) { ?><li><a class="fa fa-instagram clrblck" href="{{$contact_us->linkedin}}" title="Instagram" target="_blank"></a></li><?php } ?>
              </ul>
            </div>
          </div>
          ...
          <div class="menu_side">
            <div id="navbar_menu">
              <ul class="first-ul">
				...
				<li><a id="products" href="<?php echo url('/'.$title.'/products/category');?>">Mobiles</a></li>
                ...
                <li><a id="promotiontab" href="<?php echo url('/'.$title.'/promotion');?>">Promotion</a></li>
