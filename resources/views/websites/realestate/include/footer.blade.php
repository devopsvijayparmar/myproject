<footer id="footer">
    ...
    <script src="{{ asset('/websites/realestate/js/jquery.js') }}"></script>
    <script src="{{ asset('/websites/realestate/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('/owl/owl.carousel-2.3.4.min.js') }}"></script>
    <script src="{{ asset('/websites/realestate/js/mousescroll.js') }}"></script>
    <script src="{{ asset('/websites/realestate/js/smoothscroll.js') }}"></script>
    <script src="{{ asset('/websites/realestate/js/jquery.prettyPhoto.js') }}"></script>
    <script src="{{ asset('/websites/realestate/js/jquery.isotope.min.js') }}"></script>
    <script src="{{ asset('/websites/realestate/js/jquery.inview.min.js') }}"></script>
    <script src="{{ asset('/websites/realestate/js/wow.min.js') }}"></script>
    <script src="{{ asset('/websites/realestate/js/main.js') }}"></script>
