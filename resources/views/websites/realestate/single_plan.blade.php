        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center clr-white">
					...
					<a class="clr-white" href="{{url('/')}}">Home</a> <a class="clr-white">/<a> <a class="clr-white" href="#">Plans</a>
                </div>
            </div>
        </div>
    </section><!--/#cta-->
                        ...
                        <article>
                            <header class="entry-header">
                                <div class="entry-thumbnail">
                                    <img class="img-responsive blog_card_img" src="{{$plan->image_1}}" alt="">
                                     <a class="preview" href="{{$plan->image_1}}" rel="prettyPhoto"><span class="post-format post-format-video"><i class="fa fa-film"></i></span></a>
                                </div>
