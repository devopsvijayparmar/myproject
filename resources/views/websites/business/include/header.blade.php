...
<head>
	...
	?>
	<!-- core CSS -->
    <link href="{{ asset('/websites/business/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/business/css/font-awesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/business/css/animate.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('/websites/business/css/prettyPhoto.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/business/css/main.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/business/css/responsive.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/business/css/custom.css') }}" rel="stylesheet">
