<footer id="footer">
    ...
    <script src="{{ asset('/websites/agency/js/jquery.prettyPhoto.js') }}"></script>
    <script src="{{ asset('/websites/agency/js/jquery.isotope.min.js') }}"></script>
    <script src="{{ asset('/websites/agency/js/jquery.inview.min.js') }}"></script>
    <script src="{{ asset('/websites/agency/js/wow.min.js') }}"></script>
    <script src="{{ asset('/websites/agency/js/main.js') }}"></script>
