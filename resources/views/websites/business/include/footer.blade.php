<footer id="footer">
    ...
    <script src="{{ asset('/websites/business/js/jquery.js') }}"></script>
    <script src="{{ asset('/websites/business/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('/owl/owl.carousel-2.3.4.min.js') }}"></script>
    <script src="{{ asset('/websites/business/js/mousescroll.js') }}"></script>
    <script src="{{ asset('/websites/business/js/smoothscroll.js') }}"></script>
    <script src="{{ asset('/websites/business/js/jquery.prettyPhoto.js') }}"></script>
    <script src="{{ asset('/websites/business/js/jquery.isotope.min.js') }}"></script>
    <script src="{{ asset('/websites/business/js/jquery.inview.min.js') }}"></script>
    <script src="{{ asset('/websites/business/js/wow.min.js') }}"></script>
    <script src="{{ asset('/websites/business/js/main.js') }}"></script>
