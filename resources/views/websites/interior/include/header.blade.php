...
<head>
	...
	<!-- core CSS -->
    <link href="{{ asset('/websites/interior/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/interior/css/font-awesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/interior/css/animate.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('/websites/interior/css/prettyPhoto.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/interior/css/main.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/interior/css/responsive.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/interior/css/custom.css') }}" rel="stylesheet">
