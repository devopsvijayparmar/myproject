<footer id="footer">
    ...
    <script src="{{ asset('/websites/interior/js/jquery.js') }}"></script>
    <script src="{{ asset('/websites/interior/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('/owl/owl.carousel-2.3.4.min.js') }}"></script>
    <script src="{{ asset('/websites/interior/js/mousescroll.js') }}"></script>
    <script src="{{ asset('/websites/interior/js/smoothscroll.js') }}"></script>
    <script src="{{ asset('/websites/interior/js/jquery.prettyPhoto.js') }}"></script>
    <script src="{{ asset('/websites/interior/js/jquery.isotope.min.js') }}"></script>
    <script src="{{ asset('/websites/interior/js/jquery.inview.min.js') }}"></script>
    <script src="{{ asset('/websites/interior/js/wow.min.js') }}"></script>
    <script src="{{ asset('/websites/interior/js/main.js') }}"></script>
