...
<head>
	...
	<!-- core CSS -->
    <link href="{{ asset('/websites/cars-and-transportation/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/cars-and-transportation/css/font-awesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/cars-and-transportation/css/animate.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('/websites/cars-and-transportation/css/prettyPhoto.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/cars-and-transportation/css/main.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/cars-and-transportation/css/responsive.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/cars-and-transportation/css/custom.css') }}" rel="stylesheet">
