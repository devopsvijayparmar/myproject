...
<!-- bootstrap css -->
<link rel="stylesheet" href="{{ asset('/websites/fashion-and-beauty/css/bootstrap.min.css') }}" />
<!-- Site css -->
<link rel="stylesheet" href="{{ asset('/websites/fashion-and-beauty/css/style.css') }}" />
<!-- responsive css -->
<link rel="stylesheet" href="{{ asset('/websites/fashion-and-beauty/css/responsive.css') }}" />
<!-- colors css -->
<link rel="stylesheet" href="{{ asset('/websites/fashion-and-beauty/css/colors1.css') }}" />
<!-- custom css -->
<link rel="stylesheet" href="{{ asset('/websites/fashion-and-beauty/css/custom.css') }}" />
<!-- wow Animation css -->
<link rel="stylesheet" href="{{ asset('/websites/fashion-and-beauty/css/animate.css') }}" />
<!-- revolution slider css -->
<link rel="stylesheet" type="text/css" href="{{ asset('/websites/fashion-and-beauty/revolution/css/settings.css') }}" />
<link rel="stylesheet" type="text/css" href="{{ asset('/websites/fashion-and-beauty/revolution/css/layers.css') }}" />
<link rel="stylesheet" type="text/css" href="{{ asset('/websites/fashion-and-beauty/revolution/css/navigation.css') }}" />
