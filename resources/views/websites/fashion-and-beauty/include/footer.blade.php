...
<!-- end footer -->
<!-- js section -->
<script src="{{ url('/websites/fashion-and-beauty/js/jquery.min.js') }}"></script>
<script src="{{ url('/websites/fashion-and-beauty/js/bootstrap.min.js') }}"></script>
<!-- menu js -->
<script src="{{ url('/websites/fashion-and-beauty/js/menumaker.js') }}"></script>
<!-- wow animation -->
<script src="{{ url('/websites/fashion-and-beauty/js/wow.js') }}"></script>
<!-- custom js -->
<script src="{{ url('/websites/fashion-and-beauty/js/custom.js') }}"></script>
<!-- revolution js files -->
<script src="{{ url('/websites/fashion-and-beauty/revolution/js/jquery.themepunch.tools.min.js') }}"></script>
<script src="{{ url('/websites/fashion-and-beauty/revolution/js/jquery.themepunch.revolution.min.js') }}"></script>
<script src="{{ url('/websites/fashion-and-beauty/revolution/js/extensions/revolution.extension.actions.min.js') }}"></script>
<script src="{{ url('/websites/fashion-and-beauty/revolution/js/extensions/revolution.extension.carousel.min.js') }}"></script>
<script src="{{ url('/websites/fashion-and-beauty/revolution/js/extensions/revolution.extension.kenburn.min.js') }}"></script>
<script src="{{ url('/websites/fashion-and-beauty/revolution/js/extensions/revolution.extension.layeranimation.min.js') }}"></script>
<script src="{{ url('/websites/fashion-and-beauty/revolution/js/extensions/revolution.extension.migration.min.js') }}"></script>
<script src="{{ url('/websites/fashion-and-beauty/revolution/js/extensions/revolution.extension.navigation.min.js') }}"></script>
<script src="{{ url('/websites/fashion-and-beauty/revolution/js/extensions/revolution.extension.parallax.min.js') }}"></script>
<script src="{{ url('/websites/fashion-and-beauty/revolution/js/extensions/revolution.extension.slideanims.min.js') }}"></script>
<script src="{{ url('/websites/fashion-and-beauty/revolution/js/extensions/revolution.extension.video.min.js') }}"></script>
