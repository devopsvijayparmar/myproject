...
<head>
	...
	<!-- core CSS -->
    <link href="{{ asset('/websites/industrial/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/industrial/css/font-awesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/industrial/css/animate.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('/websites/industrial/css/prettyPhoto.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/industrial/css/main.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/industrial/css/responsive.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/industrial/css/custom.css') }}" rel="stylesheet">
