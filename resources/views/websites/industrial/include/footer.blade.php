<footer id="footer">
    ...
    <script src="{{ asset('/websites/industrial/js/jquery.js') }}"></script>
    <script src="{{ asset('/websites/industrial/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('/owl/owl.carousel-2.3.4.min.js') }}"></script>
    <script src="{{ asset('/websites/industrial/js/mousescroll.js') }}"></script>
    <script src="{{ asset('/websites/industrial/js/smoothscroll.js') }}"></script>
    <script src="{{ asset('/websites/industrial/js/jquery.prettyPhoto.js') }}"></script>
    <script src="{{ asset('/websites/industrial/js/jquery.isotope.min.js') }}"></script>
    <script src="{{ asset('/websites/industrial/js/jquery.inview.min.js') }}"></script>
    <script src="{{ asset('/websites/industrial/js/wow.min.js') }}"></script>
    <script src="{{ asset('/websites/industrial/js/main.js') }}"></script>
