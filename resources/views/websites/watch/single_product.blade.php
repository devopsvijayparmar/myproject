 ...
 <link href="{{ asset('/websites/watch/css/single_product.css') }}" rel="stylesheet">
 <link rel='stylesheet' href="{{ url('/websites/watch/css/hizoom.css') }}">
...
@include('websites.watch.include.footer')
 <script src="{{ url('/websites/watch/js/hizoom.js') }}"></script>
<script>
