...
<!-- bootstrap css -->
<link rel="stylesheet" href="{{ url('/websites/jewellery/css/bootstrap.min.css') }}" />
<!-- Site css -->
<link rel="stylesheet" href="{{ url('/websites/jewellery/css/style.css') }}" />
<!-- responsive css -->
<link rel="stylesheet" href="{{ url('/websites/jewellery/css/responsive.css') }}" />
<!-- colors css -->
<link rel="stylesheet" href="{{ url('/websites/jewellery/css/colors1.css') }}" />
<!-- custom css -->
<link rel="stylesheet" href="{{ url('/websites/jewellery/css/custom.css') }}" />
<!-- wow Animation css -->
<link rel="stylesheet" href="{{ url('/websites/jewellery/css/animate.css') }}" />
<!-- revolution slider css -->
<link rel="stylesheet" type="text/css" href="{{ url('/websites/jewellery/revolution/css/settings.css') }}" />
<link rel="stylesheet" type="text/css" href="{{ url('/websites/jewellery/revolution/css/layers.css') }}" />
<link rel="stylesheet" type="text/css" href="{{ url('/websites/jewellery/revolution/css/navigation.css') }}" />
