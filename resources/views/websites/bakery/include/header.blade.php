...
<!-- bootstrap css -->
<link rel="stylesheet" href="{{ asset('/websites/bakery/css/bootstrap.min.css') }}" />
<!-- Site css -->
<link rel="stylesheet" href="{{ asset('/websites/bakery/css/style.css') }}" />
<!-- responsive css -->
<link rel="stylesheet" href="{{ asset('/websites/bakery/css/responsive.css') }}" />
<!-- colors css -->
<link rel="stylesheet" href="{{ asset('/websites/bakery/css/colors1.css') }}" />
<!-- custom css -->
<link rel="stylesheet" href="{{ asset('/websites/bakery/css/custom.css') }}" />
<!-- wow Animation css -->
<link rel="stylesheet" href="{{ asset('/websites/bakery/css/animate.css') }}" />
<!-- revolution slider css -->
<link rel="stylesheet" type="text/css" href="{{ asset('/websites/bakery/revolution/css/settings.css') }}" />
<link rel="stylesheet" type="text/css" href="{{ asset('/websites/bakery/revolution/css/layers.css') }}" />
<link rel="stylesheet" type="text/css" href="{{ asset('/websites/bakery/revolution/css/navigation.css') }}" />
