 ...
 <link href="{{ asset('/websites/bakery/css/single_product.css') }}" rel="stylesheet">
 <link rel='stylesheet' href="{{ url('/websites/bakery/css/hizoom.css') }}">
...
@include('websites.bakery.include.footer')
 <script src="{{ url('/websites/Bakery/js/hizoom.js') }}"></script>
<script>
