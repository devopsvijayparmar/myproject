...
<head>
	...
	<!-- core CSS -->
    <link href="{{ asset('/websites/furniture/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/furniture/css/font-awesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/furniture/css/animate.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('/websites/furniture/css/prettyPhoto.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/furniture/css/main.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/furniture/css/responsive.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/furniture/css/custom.css') }}" rel="stylesheet">
