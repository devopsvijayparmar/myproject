<footer id="footer">
    ...
    <script src="{{ asset('/websites/furniture/js/jquery.js') }}"></script>
    <script src="{{ asset('/websites/furniture/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('/owl/owl.carousel-2.3.4.min.js') }}"></script>
    <script src="{{ asset('/websites/furniture/js/mousescroll.js') }}"></script>
    <script src="{{ asset('/websites/furniture/js/smoothscroll.js') }}"></script>
    <script src="{{ asset('/websites/furniture/js/jquery.prettyPhoto.js') }}"></script>
    <script src="{{ asset('/websites/furniture/js/jquery.isotope.min.js') }}"></script>
    <script src="{{ asset('/websites/furniture/js/jquery.inview.min.js') }}"></script>
    <script src="{{ asset('/websites/furniture/js/wow.min.js') }}"></script>
    <script src="{{ asset('/websites/furniture/js/main.js') }}"></script>
