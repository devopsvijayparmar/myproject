<footer id="footer">
    ...
    <script src="{{ asset('/websites/garage/js/jquery.js') }}"></script>
    <script src="{{ asset('/websites/garage/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('/owl/owl.carousel-2.3.4.min.js') }}"></script>
    <script src="{{ asset('/websites/garage/js/mousescroll.js') }}"></script>
    <script src="{{ asset('/websites/garage/js/smoothscroll.js') }}"></script>
    <script src="{{ asset('/websites/garage/js/jquery.prettyPhoto.js') }}"></script>
    <script src="{{ asset('/websites/garage/js/jquery.isotope.min.js') }}"></script>
    <script src="{{ asset('/websites/garage/js/jquery.inview.min.js') }}"></script>
    <script src="{{ asset('/websites/garage/js/wow.min.js') }}"></script>
    <script src="{{ asset('/websites/garage/js/main.js') }}"></script>
