...
<head>
	...
	<!-- core CSS -->
    <link href="{{ asset('/websites/garage/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/garage/css/font-awesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/garage/css/animate.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('/websites/garage/css/prettyPhoto.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/garage/css/main.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/garage/css/responsive.css') }}" rel="stylesheet">
