					...
					<article>
						<header class="entry-header">
							<div class="entry-thumbnail">
								<a href="{{$eventdata->getDetailPageLink($title)}}"><img class="img-responsive card_img" src="{{$eventdata->image}} alt=""></a>
								<a class="preview" href="{{$eventdata->image}}" rel="prettyPhoto"><span class="post-format post-format-video"><i class="fa fa-film"></i></span></a>
							</div>
