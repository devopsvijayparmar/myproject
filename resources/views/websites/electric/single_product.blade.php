 ...
 <link href="{{ asset('/websites/electric/css/single_product.css') }}" rel="stylesheet">
 <link rel='stylesheet' href="{{ url('/websites/electric/css/hizoom.css') }}">
        ...
        <div class="row">
          <div class="col-xl-6 col-lg-12 col-md-12">
            <div class="product_detail_feature_img hizoom hi2">
              <div class='hizoom hi2'> <img src="{{url('/uploads/electric')}}/{{$electric->image_1}}" alt="#" /> </div>
            </div>
			<ul class="preview-thumbnail nav nav-tabs">
				@if($electric->image_2)
			   <li> <a class="preview" href="{{url('/uploads/electric')}}/{{$electric->image_2}}" rel="prettyPhoto"><img src="{{url('/uploads/electric')}}/{{$electric->image_2}}" /></a></li>
				@endif
			   @if($electric->image_3)
			   <li> <a class="preview" href="{{url('/uploads/electric')}}/{{$electric->image_3}}" rel="prettyPhoto"><img src="{{url('/uploads/electric')}}/{{$electric->image_3}}" /></a></li>
				@endif
			</ul>
          </div>
		 ...
		 @foreach($electrics as $productdata)
          <div class="col-md-4 col-sm-6 col-xs-12 margin_bottom_30_all">
            <div class="product_list">
              <div class="product_img">  <a href="{{url('/')}}/{{$title}}/{{App\Helpers\CryptHelper::encryptstring($productdata->id)}}/single-electric"><img class="img-responsive card_img" src="{{url('/uploads/electric')}}/{{$productdata->image_1}}" alt=""></a> </div>
...
@include('websites.electric.include.footer')
 <script src="{{ url('/websites/electric/js/hizoom.js') }}"></script>
<script>
