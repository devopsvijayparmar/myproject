 ...
 <link rel='stylesheet' href="{{ asset('/websites/electric/css/hizoom.css') }}">
        ...
        <div class="row">
          <div class="col-xl-6 col-lg-12 col-md-12">
            <div class="product_detail_feature_img hizoom hi2">
              <div class='hizoom hi2'> <img src="{{$electric->image_1}}" alt="#" /> </div>
            </div>
			<ul class="preview-thumbnail nav nav-tabs">
				@if($electric->image_2)
			   <li> <a class="preview" href="{{$electric->image_2}}" rel="prettyPhoto"><img src="{{$electric->image_2}}" /></a></li>
				@endif
			   @if($electric->image_3)
			   <li> <a class="preview" href="{{$electric->image_3}}" rel="prettyPhoto"><img src="{{$electric->image_3}}" /></a></li>
				@endif
			</ul>
          </div>
...
@include('websites.electric.include.footer')
 <script src="{{ asset('/websites/electric/js/hizoom.js') }}"></script>
<script>
