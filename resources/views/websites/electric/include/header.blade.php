...
<!-- bootstrap css -->
<link rel="stylesheet" href="{{ url('/websites/electric/css/bootstrap.min.css') }}" />
<!-- Site css -->
<link rel="stylesheet" href="{{ url('/websites/electric/css/style.css') }}" />
<!-- responsive css -->
<link rel="stylesheet" href="{{ url('/websites/electric/css/responsive.css') }}" />
<!-- colors css -->
<link rel="stylesheet" href="{{ url('/websites/electric/css/colors1.css') }}" />
<!-- custom css -->
<link rel="stylesheet" href="{{ url('/websites/electric/css/custom.css') }}" />
<!-- wow Animation css -->
<link rel="stylesheet" href="{{ url('/websites/electric/css/animate.css') }}" />
<!-- revolution slider css -->
<link rel="stylesheet" type="text/css" href="{{ url('/websites/electric/revolution/css/settings.css') }}" />
<link rel="stylesheet" type="text/css" href="{{ url('/websites/electric/revolution/css/layers.css') }}" />
<link rel="stylesheet" type="text/css" href="{{ url('/websites/electric/revolution/css/navigation.css') }}" />
          ...
          <div class="float-left">
            <div class="social_icon">
              <ul class="list-inline">
                ...
                <?php if(isset($contact_us->instagram)) { ?><li><a class="fa fa-linkedin" href="{{$contact_us->instagram}}" title="LinkedIn" target="_blank"></a></li><?php } ?>
                <?php if(isset($contact_us->linkedin)) { ?><li><a class="fa fa-instagram" href="{{$contact_us->linkedin}}" title="Instagram" target="_blank"></a></li><?php } ?>
              </ul>
            </div>
          </div>
