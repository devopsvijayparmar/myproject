  ...
  <div class="container">
    <div class="row">
      <div class="col-md-9">
        <div class="row">
          ...
          <div class="col-md-4 col-sm-6 col-xs-12 margin_bottom_30_all">
            <div class="product_list">
              <div class="product_img">  <a href="{{url('/')}}/{{$title}}/{{App\Helpers\CryptHelper::encryptstring($productdata->id)}}/single-product"><img class="img-responsive card_img" src="{{url('/uploads/electric')}}/{{$productdata->image_1}}" alt=""></a> </div>
	   ...
	   <div class="center">
	   {{ $electric->appends(request()->except('page'))->links("pagination::bootstrap-4") }}
	  </div>
