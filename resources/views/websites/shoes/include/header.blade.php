...
<!-- bootstrap css -->
<link rel="stylesheet" href="{{ url('/websites/shoes/css/bootstrap.min.css') }}" />
<!-- Site css -->
<link rel="stylesheet" href="{{ url('/websites/shoes/css/style.css') }}" />
<!-- responsive css -->
<link rel="stylesheet" href="{{ url('/websites/shoes/css/responsive.css') }}" />
<!-- colors css -->
<link rel="stylesheet" href="{{ url('/websites/shoes/css/colors1.css') }}" />
<!-- custom css -->
<link rel="stylesheet" href="{{ url('/websites/shoes/css/custom.css') }}" />
<!-- wow Animation css -->
<link rel="stylesheet" href="{{ url('/websites/shoes/css/animate.css') }}" />
<!-- revolution slider css -->
<link rel="stylesheet" type="text/css" href="{{ url('/websites/shoes/revolution/css/settings.css') }}" />
<link rel="stylesheet" type="text/css" href="{{ url('/websites/shoes/revolution/css/layers.css') }}" />
<link rel="stylesheet" type="text/css" href="{{ url('/websites/shoes/revolution/css/navigation.css') }}" />
