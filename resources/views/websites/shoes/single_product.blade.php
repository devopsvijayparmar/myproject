 ...
 <link href="{{ asset('/websites/shoes/css/single_product.css') }}" rel="stylesheet">
 <link rel='stylesheet' href="{{ url('/websites/shoes/css/hizoom.css') }}">
...
@include('websites.shoes.include.footer')
 <script src="{{ url('/websites/shoes/js/hizoom.js') }}"></script>
<script>
