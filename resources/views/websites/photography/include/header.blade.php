...
<head>
	...
	?>
	<!-- core CSS -->
    <link href="{{ asset('/websites/photography/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/photography/css/font-awesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/photography/css/animate.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('/websites/photography/css/prettyPhoto.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/photography/css/main.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/photography/css/responsive.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/photography/css/custom.css') }}" rel="stylesheet">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        <li id="hometab" class="scroll"><a href="{{url('/')}}/{{$title}}">Home</a></li>
						 <li id="photoshootstab" class="scroll"><a href="{{url('/')}}/{{$title}}/photo-shoots/category">Photo Shoots</a></li>
