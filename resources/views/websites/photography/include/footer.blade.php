<footer id="footer">
    ...
    <script src="{{ asset('/websites/photography/js/jquery.js') }}"></script>
    <script src="{{ asset('/websites/photography/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('/owl/owl.carousel-2.3.4.min.js') }}"></script>
    <script src="{{ asset('/websites/photography/js/mousescroll.js') }}"></script>
    <script src="{{ asset('/websites/photography/js/smoothscroll.js') }}"></script>
    <script src="{{ asset('/websites/photography/js/jquery.prettyPhoto.js') }}"></script>
    <script src="{{ asset('/websites/photography/js/jquery.isotope.min.js') }}"></script>
    <script src="{{ asset('/websites/photography/js/jquery.inview.min.js') }}"></script>
    <script src="{{ asset('/websites/photography/js/wow.min.js') }}"></script>
    <script src="{{ asset('/websites/photography/js/main.js') }}"></script>
