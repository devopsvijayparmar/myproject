 ...
 <link href="{{ asset('/websites/cloth/css/single_product.css') }}" rel="stylesheet">
 <link rel='stylesheet' href="{{ url('/websites/cloth/css/hizoom.css') }}">
...
@include('websites.cloth.include.footer')
 <script src="{{ url('/websites/cloth/js/hizoom.js') }}"></script>
<script>
