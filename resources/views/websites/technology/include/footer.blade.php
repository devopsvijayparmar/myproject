<footer id="footer">
    ...
    <script src="{{ asset('/websites/technology/js/jquery.js') }}"></script>
    <script src="{{ asset('/websites/technology/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('/owl/owl.carousel-2.3.4.min.js') }}"></script>
    <script src="{{ asset('/websites/technology/js/mousescroll.js') }}"></script>
    <script src="{{ asset('/websites/technology/js/smoothscroll.js') }}"></script>
    <script src="{{ asset('/websites/technology/js/jquery.prettyPhoto.js') }}"></script>
    <script src="{{ asset('/websites/technology/js/jquery.isotope.min.js') }}"></script>
    <script src="{{ asset('/websites/technology/js/jquery.inview.min.js') }}"></script>
    <script src="{{ asset('/websites/technology/js/wow.min.js') }}"></script>
    <script src="{{ asset('/websites/technology/js/main.js') }}"></script>
