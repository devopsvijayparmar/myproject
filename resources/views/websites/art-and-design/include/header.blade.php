...
<head>
	...
	<!-- core CSS -->
    <link href="{{ asset('/websites/art-and-design/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/art-and-design/css/font-awesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/art-and-design/css/animate.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('/websites/art-and-design/css/prettyPhoto.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/art-and-design/css/main.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/art-and-design/css/responsive.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/art-and-design/css/custom.css') }}" rel="stylesheet">
