...
<head>
	...
	<!-- core CSS -->
    <link href="{{ asset('/websites/gallery/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/gallery/css/font-awesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/gallery/css/animate.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('/websites/gallery/css/prettyPhoto.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/gallery/css/main.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/gallery/css/responsive.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/gallery/css/custom.css') }}" rel="stylesheet">
