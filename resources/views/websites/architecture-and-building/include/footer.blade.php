<footer id="footer">
    ...
    <script src="{{ asset('/websites/architecture-and-building/js/jquery.js') }}"></script>
    <script src="{{ asset('/websites/architecture-and-building/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('/owl/owl.carousel-2.3.4.min.js') }}"></script>
    <script src="{{ asset('/websites/architecture-and-building/js/mousescroll.js') }}"></script>
    <script src="{{ asset('/websites/architecture-and-building/js/smoothscroll.js') }}"></script>
    <script src="{{ asset('/websites/architecture-and-building/js/jquery.prettyPhoto.js') }}"></script>
    <script src="{{ asset('/websites/architecture-and-building/js/jquery.isotope.min.js') }}"></script>
    <script src="{{ asset('/websites/architecture-and-building/js/jquery.inview.min.js') }}"></script>
    <script src="{{ asset('/websites/architecture-and-building/js/wow.min.js') }}"></script>
    <script src="{{ asset('/websites/architecture-and-building/js/main.js') }}"></script>
