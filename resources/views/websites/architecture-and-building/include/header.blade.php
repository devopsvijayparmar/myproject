...
<head>
	...
	<!-- core CSS -->
    <link href="{{ asset('/websites/architecture-and-building/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/architecture-and-building/css/font-awesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/architecture-and-building/css/animate.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('/websites/architecture-and-building/css/prettyPhoto.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/architecture-and-building/css/main.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/architecture-and-building/css/responsive.css') }}" rel="stylesheet">
    <link href="{{ asset('/websites/architecture-and-building/css/custom.css') }}" rel="stylesheet">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
						...
						<li id="plantab" class="scroll"><a href="{{url('plan')}}">Plan</a></li>
