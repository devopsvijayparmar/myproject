 @include('websites.architecture-and-building.include.header')
	...
	<section id="blog">
	 ...
	 <section id="features">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">Plans
            </div>
            <div class="row">
				@if(count($plan) > 0)
                    ...
                    <div class="blog-post blog-large wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="0ms">
                        <article>
                            <header class="entry-header">
								...
								<a class="preview" href="{{url('/uploads/plan')}}/{{$retrieved_data->image}}" rel="prettyPhoto">
                                    <img class="img-responsive card_img" src="{{url('/uploads/plan')}}/{{$retrieved_data->image}}" alt="">
									</a>
                                </div>
                            </header>
                        </article>
   ...
   <section id="features" style="padding-bottom:80px!important">
        <div class="container">
            <div class="section-header">
