        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
				...
				<li class="breadcrumb-item"><a href="{{ url('/super-admin/system') }}">System</a></li>
				<li class="breadcrumb-item">System Show</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
				...
				<div class="col-md-10">
					<table class="table table-responsive">
                      <tbody>
					   ...
					   <tr>
                        <th>Image:</th>
                        <td><img class="rp-img" src="<?php echo url('/uploads/front/system//'.$data->image);?>"</td>
						</tr>
					  <tr>
                        <th>Description:</th>
