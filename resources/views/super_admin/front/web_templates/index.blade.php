        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Web Templates</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
      <div class="container-fluid">
			<div class="card">
			 ...
			 <a type="button" class="btn btn-primary float-right ml-2" href="{{ route('web-templates.create') }}">Add</a>
			  <table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					<?php
						$i=0;
						foreach($web_templates as $retrieved_data)
						{ 
						$i++;
						?>
						<tr id="{{$i}}">
						  ...
						  <a title="Edit" class="mr-2" href="<?php echo URL::to('/'); ?>/super-admin/web-templates/{{App\Helpers\CryptHelper::encryptstring($retrieved_data->id)}}/edit"><i class="fas fa-edit text-info font-16"></i></a>
...
function(isConfirm){
  if (isConfirm) {
			$.ajax({
				url: "<?php echo URL::to('/'); ?>/super-admin/web-templates/"+id,
				type: "DELETE",
