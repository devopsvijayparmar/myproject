        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
			   <form id="main_id" method="POST" action="{{route('books.store')}}" enctype="multipart/form-data">
				@method('POST')
				@csrf
                <div class="card-body">
					<div class="row">
						...
						<div class="form-group col-md-6">
							 <label for="exampleInputEmail1">Date Released <span class="error">*</span></label>
							  <input type="date" class="form-control" id="date_released" placeholder="Enter date released" name="date_released" value="{{old('date_released')}}">
							  <span class="error">{{$errors->first('date_released')}}</span>
						</div>
					</div>
