        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{route('mobile.index')}}">Mobiles</a></li>
              <li class="breadcrumb-item active">Edit Mobile</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
			   <form id="main_id" method="POST" action="{{route('mobile.update',Crypt::encrypt($data->id))}}" enctype="multipart/form-data">
				@method('PUT')
				@csrf
                <div class="card-body">
					<div class="row">
						...
						<div class="form-group col-md-6">
							 <label for="exampleInputEmail1">Brand <span class="error">*</span></label>
							  <select class="form-control" id="brand_id" name="brand_id">
								...
								<option @if($retrieved_data->id == $data->brand_id) selected @endif  value="{{$retrieved_data->id}}">{{$retrieved_data->name}}</option>
								@endforeach
							  </select>
