        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
			   <form id="main_id" method="POST" action="<?php echo URL::to('/')?>/admin/philosophy/0" enctype="multipart/form-data">
				@method('PUT')
				@csrf
                <div class="card-body">
					...
					<div class="form-group">
						...
						<span class="error" id='description_error'>{{$errors->Philosophy->first('description')}}</span>
					</div>
                </div>
