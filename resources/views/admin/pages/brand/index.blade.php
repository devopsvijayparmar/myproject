...
<div class="modal fade" id="modal-default">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form id="main_id" method="POST" action="{{route('brand.store')}}" enctype="multipart/form-data">
			@method('POST')
			@csrf
			<div class="modal-body">
				<div class="form-group">
					<label for="exampleFormControlInput1">Brand <span style="color:red;margin-left: 2px;" class="required-error"> *</span></label>
					<input maxlength="255" type="text" id="name" name="name" class="form-control" placeholder="Enter brand">
				</div>
			</div>
...
{ 
	$.ajax({
		url: "{{ URL::to('/')}}/admin/brand/"+id+"/edit",
		type: "GET",
