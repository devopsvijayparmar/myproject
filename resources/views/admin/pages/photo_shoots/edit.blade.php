        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo url('/admin/photo-shoots');?>">Photo Shoots</a></li>
              <li class="breadcrumb-item active">Edit Photo Shoots</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit Photo Shoots</h3>
              </div>
			 
              <!-- /.card-header -->
              <!-- form start -->
			   <form id="main_id" method="POST" action="<?php echo URL::to('/')?>/admin/photo-shoots/{{App\Helpers\CryptHelper::encryptstring($data->id)}}" enctype="multipart/form-data">
				@method('PUT')
				@csrf
                <div class="card-body">
					<div class="row">
						<div class="form-group col-md-6">
							 <label for="exampleInputEmail1">Category <span class="error">*</span></label>
							  ...
							  <span class="error" id='category_error'>{{$errors->PhotoShoots->first('name')}}</span>
						</div>
						<div class="form-group col-md-6">
							 <label for="exampleInputEmail1">Name <span class="error">*</span></label>
							  ...
							  <span class="error" id='name_error'>{{$errors->PhotoShoots->first('name')}}</span>
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group col-md-4">
							...
							<img class="mar-top-10 rp-img100" src="<?php echo url('/uploads/photo_shoots/'.$data->image);?>" id="blah"/ ></br>
							<span class="error" id='image_error'>{{$errors->PhotoShoots->first('image')}}</span>
						</div>
					</div>
