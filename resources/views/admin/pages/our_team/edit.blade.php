        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
			   <form id="main_id" method="POST" action="<?php echo URL::to('/')?>/admin/our-team/{{App\Helpers\CryptHelper::encryptstring($data->id)}}" enctype="multipart/form-data">
				@method('PUT')
				@csrf
                <div class="card-body">
					<div class="row">
						...
						<div class="form-group col-md-6">
							...
							<img class="mar-top-10 rp-img100" src="<?php echo url('/uploads/our_team/'.$data->image);?>" id="blah"/ ></br>
