                ...
                <div class="card-body">
					...
					<div class="form-group">
						 <label for="exampleInputEmail1">URL Name<span class="error">*</span></label>
						  <input type="text" class="url_name form-control" onkeyup="geturlname(this.value);" id="url_name" placeholder="Enter URL Name" name="url_name" maxlength="50" value="{{$data->url_name}}">
