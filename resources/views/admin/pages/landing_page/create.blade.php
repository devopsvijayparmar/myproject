        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
			   <form id="main_id" method="POST" action="<?php echo URL::to('/')?>/admin/landing-page" enctype="multipart/form-data">
				@method('POST')
				@csrf
                <div class="card-body">
					...
					<iframe src="<?= URL::to("/"); ?>/admin/landing_page_editor" style="width: 100%;height: 600px;border: none;" frameborder="0" scrolling="no" id="editoriframe" onload="resizeIframe(this)"></iframe>
                        <script>
...
$('#landing-page-tab').addClass('active');
  ...
  function validation(){
	...
	if (url_name) {
		$.ajax({
			async : false,
			url: "<?php echo URL::to('/'); ?>/admin/exit-title",
			type: "POST",
			data: {url_name: url_name, _token: "<?php echo csrf_token(); ?>"},
