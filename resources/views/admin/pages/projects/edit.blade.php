        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
			   <form id="main_id" method="POST" action="<?php echo URL::to('/')?>/admin/projects/{{App\Helpers\CryptHelper::encryptstring($data->id)}}" enctype="multipart/form-data">
				@method('PUT')
				@csrf
                <div class="card-body">
					<div class="row">
						<div class="form-group col-md-4">
							 <label for="exampleInputEmail1">Project Type<span class="error">*</span></label>
							  <select class="form-control" id="project_type" name="project_type_fk">
								...
								<option <?php if($data->project_type_fk == $retrieved_data->id) { echo "selected";}?> value="{{$retrieved_data->id}}">{{$retrieved_data->name}}</option>
								<?php } ?>
							  </select>
					...
					<div class="form-group mb-0">
						<div class="row">
							<div class="col-md-4">
								...
								<img class="mar-top-10 rp-img100" src="<?php echo url('/uploads/projects/'.$data->image_1);?>" id="blah_1"/ ></br>
							...
							<div class="col-md-4">
								...
								<img class="mar-top-10 rp-img100"  <?php if($data->image_2) { ?> src="<?php echo url('/uploads/projects/'.$data->image_2);?>" <?php } ?> id="blah_2"/ ></br>
							...
							<div class="col-md-4">
								...
								<img class="mar-top-10 rp-img100" <?php if($data->image_3) { ?> src="<?php echo url('/uploads/projects/'.$data->image_3);?>" <?php } ?> id="blah_3"/ ></br>
