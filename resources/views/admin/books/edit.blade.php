        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
			   <form id="main_id" method="POST" action="<?php echo URL::to('/')?>/admin/books/{{App\Helpers\CryptHelper::encryptstring($data->id)}}" enctype="multipart/form-data">
				@method('PUT')
				@csrf
                <div class="card-body">
					<div class="row">
						...
						<div class="form-group col-md-6">
							 <label for="exampleInputEmail1">Date Released <span class="error">*</span></label>
							  <input type="date" class="form-control" id="date_released" placeholder="Enter date released" name="date_released" maxlength="255" value="{{ $data->date_released }}">
					...
					<div class="form-group mb-0">
						<div class="row">
							<div class="col-md-4">
								...
								<img class="mar-top-10 rp-img100" src="<?php echo url('/uploads/books/'.$data->image_1);?>" id="blah_1"/ ></br>
							...
							<div class="col-md-4">
								...
								<img class="mar-top-10 rp-img100" <?php if($data->image_2) { ?> src="<?php echo url('/uploads/books/'.$data->image_2);?>" <?php } ?> id="blah_2"/ ></br>
							...
							<div class="col-md-4">
								...
								<img class="mar-top-10 rp-img100"  <?php if($data->image_3) { ?> src="<?php echo url('/uploads/books/'.$data->image_3);?>" <?php } ?> id="blah_3"/ ></br>
