      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
		   ...
		   <li class="nav-item">
            <a href="<?php echo url('/admin/event');?>" class="nav-link" id="eventtab">
		   ...
		   <li class="nav-item">
            <a href="<?php echo url('/admin/category');?>" class="nav-link" id="categorytab">
		   ...
		   <li class="nav-item">
            <a href="<?php echo url('/admin/brand');?>" class="nav-link" id="brandtab">
            <i class="nav-icon fab fa-bandcamp"></i>
              <p>
                Brand
              </p>
		  ...
		  <li class="nav-item">
		   ...
		   <li class="nav-item">
            <a href="<?php echo url('/admin/electric');?>" class="nav-link" id="electrictab">
		  ...
		  <li class="nav-item">
            <a href="<?php echo url('/admin/books');?>" class="nav-link" id="bookstab">
         <i class="nav-icon fas fa-book-open"></i>
		    ...
		    <li class="nav-item">
            <a href="<?php echo url('/admin/about-us');?>" class="nav-link" id="about-us-tab">
		  ...
		  <li class="nav-item">
            <a href="<?php echo url('/admin/contact-us');?>" class="nav-link" id="contact-us-tab">
		   ...
		   <li class="nav-item">
            <a href="<?php echo url('/admin/gallery');?>" class="nav-link" id="gallery-tab">
             <i class="nav-icon fas fa-photo-video"></i>
              <p>
                Gallery
              </p>
		  ...
		  <li class="nav-header">BUSINESS</li>
		   ...
		   <li class="nav-item">
		    ...
		    <li class="nav-item">
            <a href="<?php echo url('/admin/address-book');?>" class="nav-link" id="address-book-tab">
		   ...
		   <li class="nav-item">
            <a href="<?php echo url('/admin/email-marketing');?>" class="nav-link" id="emailtab">
