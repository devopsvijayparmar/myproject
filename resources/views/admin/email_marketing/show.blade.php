                ...
                <div class="card-body">
					<div class="row">
						<div class="col-12 col-sm-6">
						  ...
						  <div class="col-12">
							<img src="<?php echo url('/uploads/blog/'.$data->image);?>" class="product-image" alt="Product Image">
						  </div>
						  <div class="col-12 product-image-thumbs">
							<div class="product-image-thumb active"><img src="<?php echo url('/uploads/blog/'.$data->image);?>" alt="Product Image"></div>
						  </div>
						</div>
						<div class="col-12 col-sm-6">
