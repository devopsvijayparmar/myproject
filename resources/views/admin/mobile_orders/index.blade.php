                  ...
                  <table id="example1" class="table table-bordered table-striped">
					...
					<tbody>
						...
						<tr id="{{$i}}">
						  ...
						  <td><a href="<?php echo URL::to('/'); ?>/admin/mobile/{{App\Helpers\CryptHelper::encryptstring($retrieved_data->product_fk)}}" target="_blank">{{$retrieved_data->product_name}}</a></td>
						  ...
						  <a title="View" class="mr-2" href="<?php echo URL::to('/'); ?>/admin/mobile-orders/{{App\Helpers\CryptHelper::encryptstring($retrieved_data->id)}}"><i class="fas fa-eye text-info font-16"></i></a>
