 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{url('/')}}" class="brand-link">
      <img src="{{$admin_site_setting->fav_icon}}" alt="Site Logo" class="brand-image img-circle mt-0">
     <img src="{{asset('logo/logos/admin_logo.svg')}}" class="admin_logo" alt="Site Logo">
    </a>
