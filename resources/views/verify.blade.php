		...
		<table width="90%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td align="center">
					...
					<img src="http://www.websphare.com/uploads/front/settings/20230102051621logo.png" width="250" alt="Websphare" border="0"  /></font></a>
				</td>
			</tr>
			<tr>
						...
						<tr>
							<td>
								<div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
									Admin Panel: <br> <a href="" style="color: #0f66dc; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;"></a>
                                </div>
								<div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
									Your Website: <br> <a href="" style="color: #0f66dc; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;"></a><br/><br/><br/>
                                </div>
							</td>
						</tr>
						<tr>
