...
class Mobile extends Authenticatable
{
	...
	function getImageUrl1Attribute(){
		return $this->image_1 == null ? asset('/images/image_not_found.jpg') : asset('/uploads/mobile/'.$this->image_1);
	}
	function getImageUrl2Attribute(){
		return $this->image_2 == null ? asset('/images/image_not_found.jpg') : asset('/uploads/mobile/'.$this->image_2);
	}
	function getImageUrl3Attribute(){
		return $this->image_3 == null ? asset('/images/image_not_found.jpg') : asset('/uploads/mobile/'.$this->image_3);
	}
