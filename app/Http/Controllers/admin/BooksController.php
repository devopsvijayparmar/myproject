...
class BooksController extends Controller
{
	...
	protected $validationRules = [
		...
		'image_1'=>'required|mimes:jpeg,jpg,svg,png|max:2048',
		'image_2'=>'mimes:jpeg,jpg,svg,png|max:2048',
		'image_3'=>'mimes:jpeg,jpg,svg,png|max:2048',
    ]; 
	...
	protected $validationRulesEdit = [
		...
		'date_released' => 'required',
		'description' => 'required|max:2000',
		'image_1'=>'mimes:jpeg,jpg,svg,png|max:2048',
		'image_2'=>'mimes:jpeg,jpg,svg,png|max:2048',
		'image_3'=>'mimes:jpeg,jpg,svg,png|max:2048',
    ]; 
    /**
