...
class ElectricController extends Controller
{
	...
	protected $validationRules = [
		...
		'image_1'=>'required|mimes:jpeg,jpg,svg,png,PNG|max:2048',
		'image_2'=>'mimes:jpeg,jpg,svg,png,PNG|max:2048',
		'image_3'=>'mimes:jpeg,jpg,svg,png,PNG|max:2048',
    ]; 
	...
	protected $validationRulesEdit = [
		...
		'price' => 'regex:/^\d+(\.\d{1,2})?$/',
		'description' => 'required|max:500',
		'image_1'=>'mimes:jpeg,jpg,svg,png,PNG|max:2048',
		'image_2'=>'mimes:jpeg,jpg,svg,png,PNG|max:2048',
		'image_3'=>'mimes:jpeg,jpg,svg,png,PNG|max:2048',
    ];  
